        ...
        if config.has_option('target', key):
            ...
            if match:
                for group_file in group_files:
                    ...
                    command += 'cp -rf ' + work_dir + '../' + value_rep + ' ' + out_dir_results
                    command += config.get('target', key).replace("#group", analysis_name) + '\n'
            else:
                command += 'cp -rf ' + work_dir + '../' + value + ' ' + out_dir_results + config.get('target',
                                                                                                     key) + '\n'
        else:
