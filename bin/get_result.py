...
def get_result(cfg_in,vars=None):
    ...
    dirs.append(out_dir_results+"/02_OUT/all/bar_plot/phylum/")
    dirs.append(out_dir_results+"/02_OUT/all/bar_plot/order/")
    dirs.append(out_dir_results+"/02_OUT/all/bar_plot/class/")
    dirs.append(out_dir_results+"/02_OUT/all/bar_plot/genus/")
    dirs.append(out_dir_results+"/02_OUT/all/bar_plot/family/")
    ...
    for group_file in group_files:
        ...
        dirs.append(out_dir_results+"/02_OTU/"+analysis_name+"/phylum/")
        dirs.append(out_dir_results+"/02_OTU/"+analysis_name+"/order/")
        dirs.append(out_dir_results+"/02_OTU/"+analysis_name+"/class/")
        dirs.append(out_dir_results+"/02_OTU/"+analysis_name+"/genus/")
        dirs.append(out_dir_results+"/02_OTU/"+analysis_name+"/family/")
