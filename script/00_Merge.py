...
if __name__ == '__main__':
    ...
    subject = mg.Subject(params['infile_list'], params['upload_dir'], params['out_fasta_file'], params['out_stat_file'],
                         params['required'], params['length_stat_file'], params['max_length'], params['min_length'],
                         params['length_step'], name_table_file=params['name_table'])
