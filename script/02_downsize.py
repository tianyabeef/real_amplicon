...
def read_params(args):
    ...
    parser.add_argument('-s','--stat_file',dest='statfile',metavar='INT',type=str,default=None,
            help="find the minimum from statfile, can be overrited by MINIMUM")
...
if __name__ == '__main__':
    ...
    s = Subject(params['otu_table'],params['outfile'],params['minimum'],params['keep'],params['random'])
    s.work()
